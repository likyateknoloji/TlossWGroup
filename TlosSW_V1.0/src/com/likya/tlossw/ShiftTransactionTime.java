...
public class ShiftTransactionTime extends LocalJmx {
	
	public static void main(String[] args) {
		new ShiftTransactionTime().doIt(args);
	}
	...
	public void doIt(String[] args) {
		...
		try {
			...
			parseArguments("ShiftTransactionTime", args);
			...
			mbsc.invoke(new ObjectName("MBeans:type=0"), "shiftTransactionTime", paramList, signature);
