...
public class ShiftSolstice extends LocalJmx {
	
	public static void main(String[] args) {
		new ShiftSolstice().doIt(args);
	}
	...
	public void doIt(String[] args) {
		...
		try {
			...
			parseArguments("ShiftSolstice", args);
			...
			mbsc.invoke(new ObjectName("MBeans:type=0"), "shiftSolstice", paramList, signature);
