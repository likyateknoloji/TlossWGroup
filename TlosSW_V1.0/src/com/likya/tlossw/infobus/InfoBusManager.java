			...
			while (getQueueSize() > 0) {
				...
				try {
					...
					if (infoType instanceof JobAllInfo) {
						...
						DBUtils.updateJob("tlosSWDailyScenarios10.xml", jobProperties, ParsingUtils.getJobXFullPath(jobAllInfo.getSpcId(), jobProperties.getID(), "" + jobProperties.getAgentId(), jobProperties.getLSIDateTime()));
