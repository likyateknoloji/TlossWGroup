...
public class LiveStateInfoUtilsBase {
	...
	public static LiveStateInfo getLastLiveStateInfo(JobProperties jobProperties) {
		return jobProperties.getStateInfos().getLiveStateInfos().getLiveStateInfoArray(0);
	}
	...
	protected final static LiveStateInfo insertNewLiveStateInfo(JobProperties jobProperties, StateName.Enum stateNameEnum, SubstateName.Enum substateNameEnum, StatusName.Enum statusNameEnum, int returnCode, String returnDecription) {
	...
	protected final static LiveStateInfo insertNewLiveStateInfo(JobProperties jobProperties, StateName.Enum stateNameEnum, SubstateName.Enum substateNameEnum, StatusName.Enum statusNameEnum) {
	...
	protected final static void insertNewLiveStateInfo(JobProperties jobProperties, StateName.Enum stateNameEnum, SubstateName.Enum substateNameEnum) {
	...
	protected final static LiveStateInfo insertNewLiveStateInfo(JobProperties jobProperties, int enumStateName, int enumSubstateName, int enumStatusName) {
	...
	protected final static LiveStateInfo insertNewLiveStateInfo(JobProperties jobProperties, int enumStateName, int enumSubstateName) {
	...
	protected final static void insertNewLiveStateInfo(JobProperties jobProperties, LiveStateInfo liveStateInfo) {
		synchronized (jobProperties) {
