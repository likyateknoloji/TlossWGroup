...
public class ApplyXslt {
	...
	public synchronized static JobProperties transform(String transformXsl, ArrayList<Parameter> parameterList, JobProperties job) {
		...
		// spaceWideRegistry.getInstance().getParameters();
		...
		try {
			...
			// new
			// File("D:\\likya\\projeler\\tlos\\tlos3.0\\parameters\\output.html"));
...
//			System.out.println("");
	...
	public synchronized static String transformXML(String xmlDoc, String transformXsl) {
		...
		try {
			...
			// StringReader jobReader = new StringReader(job.toString());
			StringReader jobReader2 = new StringReader(thisXMLDoc);
