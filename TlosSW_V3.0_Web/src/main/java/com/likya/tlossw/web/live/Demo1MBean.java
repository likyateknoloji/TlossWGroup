...
@ManagedBean(name = "demo1MBean")
@ViewScoped
public class Demo1MBean extends TlosSWBaseBean implements Serializable {
	...
	public final static String RESOURCELIST_PANEL = "/inc/livePanels/demo1/1.xhtml";
	public final static String RESOURCE_PANEL = "/inc/livePanels/demo1/2.xhtml";
	public final static String TLOSAGENT_PANEL = "/inc/livePanels/demo1/3.xhtml";
