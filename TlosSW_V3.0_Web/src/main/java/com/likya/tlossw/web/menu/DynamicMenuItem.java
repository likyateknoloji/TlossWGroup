...
//		System.out.println("Menu elemanlari belirleniyor ..");
		...
		if (menuitems.isEmpty()) {
			...
			menuitems.add(new MenuItems("Definitions", "ui-icon-document", "Alarms", "/inc/managementPanels/alarmSearchPanel.jsf"));
			...
			menuitems.add(new MenuItems("Advanced D.", "ui-icon-document", "Agents", "/inc/managementPanels/agentSearchPanel.jsf"));
			...
			menuitems.add(new MenuItems("Monitoring", "ui-icon-document", "Jobs & Scenarios", "#"));
			...
			menuitems.add(new MenuItems("Advanced M.", "ui-icon-document", "Agents ", "#"));
			menuitems.add(new MenuItems("Advanced M.", "ui-icon-document", "Resources ", "#"));
			menuitems.add(new MenuItems("Advanced M.", "ui-icon-document", "Program Provision ", "#"));

			menuitems.add(new MenuItems("Reporting", "ui-icon-document", "Jobs & Scenarios  ", "#"));
