...
@ManagedBean(name = "jobsStateDurationsReportMBean")
@ViewScoped 
public class JobsStateDurationsReportMBean extends ReportBase implements Serializable {
	...
	private static final Logger logger = Logger.getLogger(JobsStateDurationsReportMBean.class);
