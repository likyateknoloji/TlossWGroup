...
declare function hs:query_username($in_username as xs:string)
  as element(out:UserResourceMap)* {

for $person in doc('xmldb:exist:///db/TLOSSW/xmls/tlosSWUser10.xml')/usr:user-infos/usr:userList/usr:person 
