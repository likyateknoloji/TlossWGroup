...
public class TEJmxMpDBClient extends TEJmxMpClientBase {
	...
	public static Object checkUser(JMXConnector jmxConnector, JmxUser jmxUser) {
		...
		try {
			...
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "checkUser", paramList, signature);
	...
	public static int getNextUserId(JmxUser jmxUser) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "getNextUserId", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Integer) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static ArrayList<Person> searchUser(JmxUser jmxUser, String personXML) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "searchUser", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
	...
	public static ArrayList<SWAgent> searchAgent(JmxUser jmxUser, String agentXML) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "searchAgent", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
	...
	public static ArrayList<Alarm> searchAlarm(JmxUser jmxUser, String alarmXML) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "searchAlarm", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
	...
	public static ArrayList<Person> users(JmxUser jmxUser) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "users", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (ArrayList<Person>) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static ArrayList<Alarm> alarms(JmxUser jmxUser) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "alarms", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (ArrayList<Alarm>) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static Person searchUserByUsername(JmxUser jmxUser, String username) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "searchUserByUsername", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Person) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static SWAgent searchAgentByAgentname(JmxUser jmxUser, String agentname) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "searchAgentByAgentname", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (SWAgent) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean insertUser(JmxUser jmxUser, String personXML) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "insertUser", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Boolean) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean insertAgent(JmxUser jmxUser, String agentXML) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "insertAgent", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Boolean) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean insertAlarm(JmxUser jmxUser, String alarmXML) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "insertAlarm", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Boolean) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean updateUser(JmxUser jmxUser, String personXML) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "updateUser", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Boolean) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean updateAgent(JmxUser jmxUser, String agentXML) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "updateAgent", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Boolean) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean updateAlarm(JmxUser jmxUser, String alarmXML) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "updateAlarm", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Boolean) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteUser(JmxUser jmxUser, String personXML) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "deleteUser", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Boolean) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAgent(JmxUser jmxUser, String agentXML) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "deleteAgent", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Boolean) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAlarm(JmxUser jmxUser, String alarmXML) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "deleteAlarm", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Boolean) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static int getNextCalendarId(JmxUser jmxUser) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "getNextCalendarId", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Integer) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean insertCalendar(JmxUser jmxUser, String calendarPropertiesXML) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "insertCalendar", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Boolean) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static ArrayList<String> calendarNames(JmxUser jmxUser) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "calendarNames", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
	...
	public static int getNextScenarioId(JmxUser jmxUser) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "getNextScenarioId", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Integer) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean insertScenario(JmxUser jmxUser, String documentName, String scenarioXML, String scenarioPath) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "insertScenario", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Boolean) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static int getNextJobId(JmxUser jmxUser) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "getNextJobId", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Integer) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean insertJob(JmxUser jmxUser, String documentName, String jobPropertiesXML, String jobPath) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "insertJob", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Boolean) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static TlosProcessData getTlosDataXml(JmxUser jmxUser, String documentName) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "getTlosDataXml", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
	...
	public static ArrayList<CalendarProperties> searchCalendar(JmxUser jmxUser, String calendarPropertiesXML) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "searchCalendar", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
	...
	public static ArrayList<CalendarProperties> calendars(JmxUser jmxUser) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "calendars", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (ArrayList<CalendarProperties>) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean updateCalendar(JmxUser jmxUser, String calendarPropertiesXML) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "updateCalendar", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Boolean) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteCalendar(JmxUser jmxUser, String calendarPropertiesXML) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "deleteCalendar", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Boolean) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static int getMaxScenarioId(JmxUser jmxUser, String documentName) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "getMaxScenarioId", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Integer) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteScenario(JmxUser jmxUser, String documentName, String scenarioXML, String scenarioPath) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "deleteScenario", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Boolean) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteJob(JmxUser jmxUser, String documentName, String jobPropertiesXML, String jobPath) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "deleteJob", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Boolean) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean updateJob(JmxUser jmxUser, String documentName, String jobPropertiesXML, String jobPath) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "updateJob", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Boolean) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static JobProperties getJob(JmxUser jmxUser, String documentName, String jobPath, String jobName) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "getJob", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
	...
	public static JobProperties getJobFromId(JmxUser jmxUser, String documentName, int jobId) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "getJobFromId", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (JobProperties) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static Scenario getScenario(JmxUser jmxUser, String documentName, String scenarioPath, String scenarioName) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "getScenario", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Scenario) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static Scenario getScenarioFromId(JmxUser jmxUser, String documentName, int scenarioId) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "getScenarioFromId", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Scenario) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static TlosConfigInfo getTlosConfig(JmxUser jmxUser) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "getTlosConfig", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
	...
	public static boolean updateTlosConfig(JmxUser jmxUser, String tlosConfigInfoXML) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "updateTlosConfig", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Boolean) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static ArrayList<ResourcePermission> getPermissions(JmxUser jmxUser) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "getPermissions", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
	...
	public static boolean updatePermissions(JmxUser jmxUser, String permissionsXML) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "updatePermissions", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Boolean) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean updateScenario(JmxUser jmxUser, String documentName, String scenarioPath, String scenarioXML) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "updateScenario", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Boolean) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static ArrayList<JobProperties> getReportJobs(JmxUser jmxUser, String jobPropertiesXML, String jobPath) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "getReportJobs", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
	...
	public static byte[] getPdfDoc(JmxUser jmxUser, String str) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "getPdfDoc", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (byte[]) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static byte[] getHtmlDoc(JmxUser jmxUser, String str) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "getHtmlDoc", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (byte[]) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static int getNextTraceId(JmxUser jmxUser) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "getNextTraceId", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Integer) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean insertTrace(JmxUser jmxUser, String traceXML) {
		...
		try {
			...
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "insertTrace", paramList, signature);
	...
	public static NrpeDataInfoTypeClient retrieveMonitorAgentInfo(JmxUser jmxUser, MonitorAgentInfoTypeClient monitorAgentInfoTypeClient) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "retrieveMonitorAgentInfo", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
	...
	public static ArrayList<SLA> searchSla(JmxUser jmxUser, String slaXML) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "searchSla", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
	...
	public static boolean deleteSla(JmxUser jmxUser, String slaXML) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "deleteSla", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Boolean) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean insertSla(JmxUser jmxUser, String slaXML) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "insertSla", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Boolean) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean updateSla(JmxUser jmxUser, String slaXML) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "updateSla", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Boolean) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static ArrayList<License> searchProvision(JmxUser jmxUser, String provisionXML) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "searchProvision", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
	...
	public static boolean deleteProvision(JmxUser jmxUser, String provisionXML) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "deleteProvision", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Boolean) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean insertProvision(JmxUser jmxUser, String provisionXML) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "insertProvision", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Boolean) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean updateProvision(JmxUser jmxUser, String provisionXML) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "updateProvision", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Boolean) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static ArrayList<RNSEntryType> resources(JmxUser jmxUser) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "resources", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
	...
	public static ArrayList<String> softwares(JmxUser jmxUser) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "softwares", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
	...
	public static ArrayList<JobProperties> jobList(JmxUser jmxUser) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "jobList", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
	...
	public static ArrayList<SLA> slaList(JmxUser jmxUser) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "slaList", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
	...
	public static ArrayList<Alarm> alarmList(JmxUser jmxUser) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "alarmList", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
	...
	public static Report getDashboardReport(JmxUser jmxUser, int derinlik) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "dashboardReport", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Report) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static Calendar getGundonumu(JmxUser jmxUser) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "getGundonumu", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Calendar) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static ArrayList<AlarmInfoTypeClient> jobAlarmHistory(JmxUser jmxUser, String jobId, boolean transformToLocalTime) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "jobAlarmHistory", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
	...
	public static ArrayList<JobInfoTypeClient> getJobResultList(JmxUser jmxUser, String documentName, String jobId, int runNumber, boolean transformToLocalTime) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "getJobResultList", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
	...
	public static ArrayList<JobInfoTypeClient> getJobResultListByDates(JmxUser jmxUser, String documentName, String jobId, String date1, String date2, boolean transformToLocalTime) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "getJobResultListByDates", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (ArrayList<JobInfoTypeClient>) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static ArrayList<AlarmReport> getAlarmReportList(JmxUser jmxUser, String date1, String date2, String alarmLevel, String alarmName, String alarmUser) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "getAlarmReportList", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
	...
	public static ArrayList<JobProperties> getJobResultListByDates2(JmxUser jmxUser, String documentName, String jobId, String date1, String date2) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "getJobResultListByDates2", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (ArrayList<JobProperties>) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static com.likya.tlos.model.xmlbeans.alarmhistory.AlarmDocument.Alarm getAlarmHistoryById(JmxUser jmxUser, int alarmHistoryId) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "getAlarmHistoryById", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
	...
	public static SLA getSlaBySlaId(JmxUser jmxUser, int slaId) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "getSlaBySlaId", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (SLA) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static ArrayList<DbProperties> searchDBAccessConnection(JmxUser jmxUser, String dbAccessPropertiesXML) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "searchDBAccessConnection", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
	...
	public static boolean deleteDBAccessConnection(JmxUser jmxUser, String dbAccessPropertiesXML) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "deleteDBAccessConnection", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Boolean) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean insertDBAccessConnection(JmxUser jmxUser, String dbAccessPropertiesXML) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "insertDBAccessConnection", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Boolean) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean updateDBAccessConnection(JmxUser jmxUser, String dbAccessPropertiesXML) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "updateDBAccessConnection", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Boolean) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean checkDBConnectionName(JmxUser jmxUser, String dbAccessPropertiesXML) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "checkDBConnectionName", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Boolean) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static int getNextDbConnectionId(JmxUser jmxUser) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "getNextDbConnectionId", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Integer) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static ArrayList<FtpProperties> ftpConnectionList(JmxUser jmxUser) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "ftpConnectionList", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
	...
	public static ArrayList<FtpProperties> searchFTPAccessConnection(JmxUser jmxUser, String ftpAccessPropertiesXML) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "searchFTPAccessConnection", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (ArrayList<FtpProperties>) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteFTPAccessConnection(JmxUser jmxUser, String ftpPropertiesXML) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "deleteFTPAccessConnection", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Boolean) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean checkFTPConnectionName(JmxUser jmxUser, String ftpAccessPropertiesXML) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "checkFTPConnectionName", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Boolean) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean insertFTPAccessConnection(JmxUser jmxUser, String ftpAccessPropertiesXML) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "insertFTPAccessConnection", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Boolean) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean updateFTPAccessConnection(JmxUser jmxUser, String ftpAccessPropertiesXML) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "updateFTPAccessConnection", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Boolean) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static int getNextFTPConnectionId(JmxUser jmxUser) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "getNextFTPConnectionId", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Integer) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static int getNextWSDefinitionId(JmxUser jmxUser) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "getNextWSDefinitionId", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Integer) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean insertWSDefinition(JmxUser jmxUser, String wsPropertiesXML) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "insertWSDefinition", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Boolean) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static ArrayList<WebServiceDefinition> webServiceList(JmxUser jmxUser) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "webServiceList", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
	...
	public static ArrayList<UserAccessProfile> searchWSAccessProfiles(JmxUser jmxUser, String userAccessProfileXML) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "searchWSAccessProfiles", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
	...
	public static int getNextWSUserProfileId(JmxUser jmxUser) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "getNextWSUserProfileId", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Integer) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean insertWSAccessProfile(JmxUser jmxUser, String userAccessProfileXML) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "insertWSAccessProfile", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Boolean) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteWSAccessProfile(JmxUser jmxUser, String userAccessProfileXML) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "deleteWSAccessProfile", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Boolean) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean updateWSAccessProfile(JmxUser jmxUser, String userAccessProfileXML) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "updateWSAccessProfile", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
			return (Boolean) o;
		} catch (Exception e) {
			e.printStackTrace();
	...
	public static ArrayList<WebServiceDefinition> webServiceListForActiveUser(JmxUser jmxUser, int userId) {
		...
		try {
			MBeanServerConnection mbeanServerConnection = jmxConnector.getMBeanServerConnection();
			o = mbeanServerConnection.invoke(new ObjectName("MBeans:type=" + RDBO), "webServiceListForActiveUser", paramList, signature);
			TEJmxMpClient.disconnect(jmxConnector);
